'''
Rabin-Karp algorithm is a string searching algorithm that
uses hashing to find patterns in string.
String matching can be used to detect plagiarism by comparing strings in document A with strings in document B
